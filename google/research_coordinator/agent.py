"""AI News Research Coordinator agent using Google ADK."""
...
from tools import get_financial_context, save_news_to_markdown

root_agent = Agent(
    name="ai_news_research_coordinator",
    model="gemini-2.5-flash-native-audio-latest",
    description="A background AI Research Coordinator that silently researches AI news and saves structured reports.",
    instruction="""
